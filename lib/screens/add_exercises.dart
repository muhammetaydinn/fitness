...
class _AddExercisesScreenState extends State<AddExercisesScreen> {
          ...
          child: Column(
            children: [
                        ...
                        Obx(
                          () => ElevatedButton(
                            onPressed:
                                ...
                                //if program name and day number is not empty
                                //then show create program button
                                _allController.programName.value.isNotEmpty &&
                                        _allController
                                            .dayNumber.value.isNotEmpty
                                    ? () {
                                        var uuid = const Uuid();
                                        createProgram(
              ...
              Expanded(
                ...
                () => ListView.builder(
                  itemCount:
                      _allController.programModel.value.days?.length ?? 0,
                          ...
                          IconButton(
                              ...
                              getImagePaths(
                                ...
                                */
                                ...
                                //show all exercises
                                //search exercises and add to day

                                Get.toNamed('/searchAddExercises',
                                    arguments: index);
                              },
                              icon: const Icon(
                                Icons.add_outlined,
  ...
  void createProgram(
    ...
    for (var i = 0; i < numberDays; i++) {
      days.add(Day(
          name: 'Day ${i + 1}',
          exercises: [])); //add day to program with empty exercises
    }
    ...
    _allController.setProgramModel = ProgramModel(
      ...
      days: _allController.programModel.value.days, //add days to program
      dayId: dayId,
    );
  }

...
//                   child: Obx(
//                 () => ListView.builder(
//                     itemCount: _allController.filteredList.length,
//                     itemBuilder: (context, index) {
//                       return ListTile(
//                           onTap: () {
//                             Get.toNamed('/movementDetail',
//                                 arguments:
//                                     _allController.filteredList[index].id);
//                           },
//                           title: Text(_allController.filteredList[index].name),

//                           // subtitle: Text(exercisesList[index].level),
//                           leading: Text(
//                               _allController.filteredList[index].id.toString()),
//                           subtitle: Text(convertToSnakeCase(
//                               _allController.filteredList[index].name)),
//                           trailing:
